...
export class StorageKeys {
    public static PROJECTM_USR_DATA_KEY: string = "projectm-usr-data-storage";
    public static PROJECTM_TOKEN_DATA_KEY: string = "projectm-token-data-storage";
    public static PROJECTM_TOKEN_REFRESHING: string = "projectm-token-refreshing";
}
...
export class StorageService {
    ...
    public static tokenData(): ITokenData {
        const tokens = StorageService.item<ITokenData>(StorageKeys.PROJECTM_TOKEN_DATA_KEY);
    ...
    public static setTokenData(tokens: ITokenData): void {
        StorageService.item(StorageKeys.PROJECTM_TOKEN_DATA_KEY, tokens);
    }

    public static clearUsrData(): void {
        StorageService.item(StorageKeys.PROJECTM_TOKEN_DATA_KEY, null);
        StorageService.item(StorageKeys.PROJECTM_USR_DATA_KEY, null);
    }
    ...
    public static usrData(): IUsrData {
        const usr = StorageService.item<IUsrData>(StorageKeys.PROJECTM_USR_DATA_KEY);
    ...
    public static isTokenRefreshing(bit: boolean | null = null): boolean | null {
        if (notNullOrEmpty(bit)) {
            StorageService.item(StorageKeys.PROJECTM_TOKEN_REFRESHING, bit);
            return null;
        }

        const data = StorageService.item<boolean>(StorageKeys.PROJECTM_TOKEN_REFRESHING);
        return data || false;
    }
}